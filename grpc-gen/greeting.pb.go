...
func init() {
	proto.RegisterType((*Request)(nil), "greeting.Request")
	proto.RegisterType((*Response)(nil), "greeting.Response")
}
...
var fileDescriptor_6acac03ccd168a87 = []byte{
	...
	0xb9, 0xd8, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x84, 0x84, 0xb8, 0x58, 0x52, 0x12, 0x4b,
	0x12, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0xc0, 0x6c, 0x25, 0x27, 0x2e, 0x8e, 0xa0, 0xd4,
	0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0x6c, 0xf2, 0x42, 0x7c, 0x5c, 0x4c, 0x99, 0x29, 0x12, 0x4c,
	0x60, 0x11, 0xa6, 0xcc, 0x14, 0x90, 0x9a, 0x92, 0xcc, 0xdc, 0x54, 0x09, 0x66, 0x05, 0x46, 0x0d,
	0xe6, 0x20, 0x30, 0xdb, 0xc8, 0x8a, 0x8b, 0xc3, 0x1d, 0x6a, 0x9d, 0x90, 0x1e, 0x17, 0x6b, 0x70,
	0x62, 0xa5, 0x47, 0xa6, 0x90, 0xa0, 0x1e, 0xdc, 0x49, 0x50, 0xfb, 0xa5, 0x84, 0x90, 0x85, 0x20,
	0x76, 0x26, 0xb1, 0x81, 0xdd, 0x6b, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xd4, 0x4d, 0xc9, 0xfa,
	0xc1, 0x00, 0x00, 0x00,
}
...
func (c *greetingClient) SayHi(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/greeting.Greeting/SayHi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGreetingServer) SayHi(ctx context.Context, req *Request) (*Response, error) {
...
func _Greeting_SayHi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greeting.Greeting/SayHi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServer).SayHi(ctx, req.(*Request))
	}
